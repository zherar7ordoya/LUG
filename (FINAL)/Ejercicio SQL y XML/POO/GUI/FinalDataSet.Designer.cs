...
namespace GUI {
    ...
    public partial class FinalDataSet : global::System.Data.DataSet {
        ...
        public partial class ClienteDataTable : global::System.Data.TypedTableBase<ClienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ClienteRow AddClienteRow(int Codigo, string Nombre, string Apellido, int DNI, System.DateTime FechaNacimiento, string Email) {
...
namespace GUI.FinalDataSetTableAdapters {
    ...
    public partial class ClienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Cliente] WHERE (([Codigo] = @Original_Codigo) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Apellido = 1 AND [Apellido] IS NULL) OR ([Apellido] = @Original_Apellido)) AND ((@IsNull_DNI = 1 AND [DNI] IS NULL) OR ([DNI] = @Original_DNI)) AND ((@IsNull_FechaNacimiento = 1 AND [FechaNacimiento] IS NULL) OR ([FechaNacimiento] = @Original_FechaNacimiento)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Cliente] ([Codigo], [Nombre], [Apellido], [DNI], [FechaNacimiento], [Email]) VALUES (@Codigo, @Nombre, @Apellido, @DNI, @FechaNacimiento, @Email);
SELECT Codigo, Nombre, Apellido, DNI, FechaNacimiento, Email FROM Cliente WHERE (Codigo = @Codigo)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Cliente] SET [Codigo] = @Codigo, [Nombre] = @Nombre, [Apellido] = @Apellido, [DNI] = @DNI, [FechaNacimiento] = @FechaNacimiento, [Email] = @Email WHERE (([Codigo] = @Original_Codigo) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Apellido = 1 AND [Apellido] IS NULL) OR ([Apellido] = @Original_Apellido)) AND ((@IsNull_DNI = 1 AND [DNI] IS NULL) OR ([DNI] = @Original_DNI)) AND ((@IsNull_FechaNacimiento = 1 AND [FechaNacimiento] IS NULL) OR ([FechaNacimiento] = @Original_FechaNacimiento)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)));
SELECT Codigo, Nombre, Apellido, DNI, FechaNacimiento, Email FROM Cliente WHERE (Codigo = @Codigo)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::GUI.Properties.Settings.Default.FinalConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Codigo, Nombre, Apellido, DNI, FechaNacimiento, Email FROM dbo.Cliente";
        ...
        public virtual int Fill(FinalDataSet.ClienteDataTable dataTable) {
        ...
        public virtual FinalDataSet.ClienteDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            FinalDataSet.ClienteDataTable dataTable = new FinalDataSet.ClienteDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(FinalDataSet.ClienteDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Codigo, string Original_Nombre, string Original_Apellido, global::System.Nullable<int> Original_DNI, global::System.Nullable<global::System.DateTime> Original_FechaNacimiento, string Original_Email) {
        ...
        public virtual int Insert(int Codigo, string Nombre, string Apellido, global::System.Nullable<int> DNI, global::System.Nullable<global::System.DateTime> FechaNacimiento, string Email) {
        ...
        public virtual int Update(int Codigo, string Nombre, string Apellido, global::System.Nullable<int> DNI, global::System.Nullable<global::System.DateTime> FechaNacimiento, string Email, int Original_Codigo, string Original_Nombre, string Original_Apellido, global::System.Nullable<int> Original_DNI, global::System.Nullable<global::System.DateTime> Original_FechaNacimiento, string Original_Email) {
        ...
        public virtual int Update(string Nombre, string Apellido, global::System.Nullable<int> DNI, global::System.Nullable<global::System.DateTime> FechaNacimiento, string Email, int Original_Codigo, string Original_Nombre, string Original_Apellido, global::System.Nullable<int> Original_DNI, global::System.Nullable<global::System.DateTime> Original_FechaNacimiento, string Original_Email) {
            return this.Update(Original_Codigo, Nombre, Apellido, DNI, FechaNacimiento, Email, Original_Codigo, Original_Nombre, Original_Apellido, Original_DNI, Original_FechaNacimiento, Original_Email);
        }
    }
