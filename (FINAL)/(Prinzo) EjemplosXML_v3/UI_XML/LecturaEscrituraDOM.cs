...
namespace UI_XML
{
    public partial class LecturaEscrituraDOM : Form
    {
        ...
        {
            //SETEO DE LA GRILLA
            grdPersonas.AllowDrop = true;
            grdPersonas.AllowUserToAddRows = true;
            grdPersonas.AllowUserToDeleteRows = false;
            grdPersonas.AllowUserToOrderColumns = true;
            grdPersonas.AllowUserToResizeColumns = false;
            grdPersonas.AllowUserToResizeRows = false;
            grdPersonas.RowHeadersVisible = false;

            var _with1 = grdPersonas.Columns;
            _with1.Add("cNombre", "Nombre");
            _with1.Add("cApellido", "Apellido");
            _with1.Add("cSaldo", "Saldo");

            //INTRODUCCION DE DATOS
            grdPersonas.Rows.Add("José", "Fernandez", "1200");
            grdPersonas.Rows.Add("Matrín", "Rodriguez", "2500");
            grdPersonas.Rows.Add("Pedro", "Perez", "1850");
        ...
        private void btnCargar_Click(object sender, EventArgs e)
        {
            ...
            if (!(MiXMLD == null))
            {
                ...
                foreach (XmlNode mXMLN in mXMLERaiz.ChildNodes)
                {
                    ...
                    {
                        grdPersonas.Rows.Add(mNombre, mApellido, mSaldo);
                    }
        ...
        private void btnVer_Click(object sender, EventArgs e)
        {
            if ((MiXMLD != null))
            {
                txtPersonasXML.Text = MiXMLD.InnerXml;
            }
            else
            {
                txtPersonasXML.Text = "No se ha creado aún el XMLDocument";
        ...
        {
            txtPersonasXML.Text = (MiXMLD.FirstChild.OuterXml + "\r\n");
        ...
        private void MostrarNodo(XmlNode pNodo, int pNivel = 0)
        {
            ...
            switch (pNodo.NodeType)
            {
                ...
                case XmlNodeType.Comment:
                    txtPersonasXML.Text += pNodo.Value + "\r\n";
                    break;
                case XmlNodeType.Text:
                    ...
                    txtPersonasXML.Text += pNodo.InnerText + "\r\n";
                    break;
