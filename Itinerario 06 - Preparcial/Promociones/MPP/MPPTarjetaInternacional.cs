...
namespace MPP
{
    public class MPPTarjetaInternacional : IGestor<BETarjetaInternacional>
    {
        #region "Constructor"
        public MPPTarjetaInternacional()
        {
            oDatos = new Acceso();
        }
        Acceso oDatos;
        ...
        public bool Guardar(BETarjetaInternacional Objeto)
        {
            ...
            Hdatos.Add("@Provincia", String.Empty);
        ...
        public List<BETarjetaInternacional> ListarTodo()
        {
            ...
            if (Dt.Rows.Count > 0)
            {
                ...
                {
                    //Si es null, es internacional (campo provincia null)
                    if ((string)Item[6]=="")
                    {
        ...
        //Metodo para validar que no se ingrese el mismo numero de tarjeta
        bool Existe_NumTarjeta(BETarjetaInternacional obj)
        {
