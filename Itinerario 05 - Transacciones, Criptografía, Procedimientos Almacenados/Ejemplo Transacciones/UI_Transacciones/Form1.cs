...
namespace UI_Transacciones
{
    public partial class Form1 : Form
    {
        ...
        private void BtnCargar_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection Conn = new SqlConnection(ConfigurationManager.ConnectionStrings["Empleados"].ToString());
...
/* comienza ejemplo para atomicidad*/
                Comando = new SqlCommand("INSERT INTO EMPLEADO (IdEmpleado, Nombre, Sueldo) Values(9,'Gerardo',1000)", Conn);
