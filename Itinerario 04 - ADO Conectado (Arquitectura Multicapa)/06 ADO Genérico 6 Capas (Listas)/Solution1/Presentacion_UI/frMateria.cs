...
namespace Presentacion_UI
{
    public partial class frMateria : Form
    {
        ...
        public void CargarGrilla()
        {
            ...
            this.dataGridView1.DataSource = oBLLMat.ListarTodo();
        ...
        private void dataGridView1_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                oBEMat = (BEMateria)this.dataGridView1.CurrentRow.DataBoundItem;

                //si el indice de la columna es 0, entonces Edito
                if (e.ColumnIndex == 0)
                {   //instancio el form ABM de materia y le paso los para editar
                    ABMMaterias oABMNat = new ABMMaterias();
                    oABMNat.textcod.Text = oBEMat.Codigo.ToString();
                    oABMNat.textNombre.Text = oBEMat.Materia;
